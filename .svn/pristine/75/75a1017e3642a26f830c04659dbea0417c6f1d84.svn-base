<template>
  <a-card>
    ...
    >
      <a-row v-if="baseData.purchaseType === '2'">
        <a-col :md="24" :sm="24">
          <a-form-item label="邀请招标理由" v-bind="BASE.threeItemLayout">
            <a-textarea
              :rows="3"
...
import { findProjectExplain, updateProjectExplain } from "@/services/bid";
export default {
  props: {
    baseData: {
      type: Object
