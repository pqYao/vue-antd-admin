...
import { findSubContractForPage } from "@/services/other";
...
export default {
  ...
  methods: {
    ...
    handleEdit(id) {
      this.$router.push({
        path: `/other/prepare/sub-contract-edit/${id}`
      });
    },
    projectDetail(id) {
      this.$router.push({
        path: `/other/prepare/detail/${id}`
      });
    },
    handleDetail(id) {
      this.$router.push({
        path: `/other/prepare/sub-contract-detail/${id}`
      });
    },
