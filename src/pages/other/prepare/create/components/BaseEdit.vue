  ...
  <a-card>
    ...
    >
      ...
      <a-row>
        ...
        <a-col :md="8" :sm="24" v-if="formData.purchaseType == '9'">
      ...
      <a-row>
        ...
        <a-col
          ...
          :sm="24"
          v-if="
            formData.purchaseType == '5' ||
              formData.purchaseType == '7'
          "
        >
...
import AgencyOrgManegerSelect from "@/pages/bid/prepare/create/components/AgencyOrgManegerSelect";
import {
  addProjectInfo,
  findProjectInfoById,
  updateProjectInfo,
