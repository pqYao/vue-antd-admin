    ...
    <a-card>
      <Heading name="分标明细">
        ...
        <div class="table-operations" v-if="pageType == 1">
          <a-button type="primary" @click="fnHandleAdd">
            <i :class="['iconfont', 'icon-xinzeng']"></i>
            新增
          </a-button>
          <pop-confirm-btn
            title="确定快捷分标?"
            hoverContent="将项目分成1个标，并自动关联项目下所有产品"
            btnName="快捷分标"
            @confirm-action="fnFastSubtender">
          </pop-confirm-btn>
          <a-popconfirm
          ...
          >
            <a-button type="primary" @click="fnDeleteDivideTender(2)">
...
export default {
  ...
  components: {
    ...
    PopConfirmBtn: () => import("@/components/button/PopConfirmBtn")
  },
  props: {
    //0: 详情; 1: 编辑
    pageType: {
