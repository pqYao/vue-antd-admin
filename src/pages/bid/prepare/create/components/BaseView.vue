...
import { findProjectInfoById, findProjectExplain } from "@/services/bid";
  ...
  data() {
    return {
      ...
      baseList: [
        ...
        { label: "采购方式", key: "purchaseType", dic: true, show: true },
        {
          label: "采购项目名称",
          key: "projectName",
          span: "2",
        ...
        { label: "标包划分", key: "purchaseFlag", flag: true, show: true },
      ...
      explainlist: [
        { label: "邀请招标理由", key: "projectInvite", show: false, span: 3 },
