<template>
  <a-card>
      ...
      <template v-slot:leftIcon>
        <a-popover placement="bottom">
          <template slot="content">
            <p>
              采购文件售卖开始时间、采购文件售卖截止时间、应答截止时间等时间是以满24小时为一天计算
            </p>
          </template>
    ...
    >
      <a-row>
        <a-col :md="8" :sm="24">
          <a-form-item label="采购文件售卖开始时间" v-bind="BASE.oneItemLayout">
            <a-date-picker
        ...
        <a-col :md="8" :sm="24">
          <a-form-item label="采购文件售卖截止时间" v-bind="BASE.oneItemLayout">
            <a-date-picker
      ...
      <a-row>
        <a-col :md="8" :sm="24">
          <a-form-item label="应答截止时间" v-bind="BASE.oneItemLayout">
            <a-date-picker
              style="width:100%;"
